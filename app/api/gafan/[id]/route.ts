...
export async function PUT(req: Request, { params }: { params: Promise<{ id: string }> }) {
  try {
    ...
    const result = await sql`
      ...
      SET 
        name = ${body.name || null},
        "programNumber" = ${body.program_number || null},
        "validYear" = ${body.valid_year || null},
        ...
        "branchNumber" = ${body.branch_number || null},
        "accountNumber" = ${body.account_number || null},
        "operatorName" = ${body.operator_name || null},
        "priceMin" = ${body.price_min || 0},
