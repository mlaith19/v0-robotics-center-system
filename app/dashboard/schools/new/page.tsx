    ...
    <div className="container mx-auto max-w-5xl p-6">
      <div className="mb-8">
        <div className="flex items-center gap-3 mb-2">
          ...
          <h1 className="text-3xl font-bold text-foreground">בית ספר חדש</h1>
        </div>
        <p className="text-muted-foreground mr-14">הוסף בית ספר חדש למערכת הרובוטיקה</p>
      </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div className="space-y-2 md:col-span-2">
                ...
                <Input
                  ...
                  placeholder="לדוגמה: בית ספר אלון"
        ...
        <Card className="border-2 border-pink-200 bg-gradient-to-br from-pink-50 to-pink-100/50 p-6">
          ...
          <div className="space-y-2">
            ...
            <Textarea
              ...
              placeholder="הערות או מידע נוסף על בית הספר..."
              rows={4}
